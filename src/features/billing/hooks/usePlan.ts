...
import { PLANS, UNLIMITED } from '@shared/constants/plans'
...
export function usePlan(): UsePlanResult {
  ...
  function withinLimit(resource: keyof PlanLimits, current: number): boolean {
    const max = definition.limits[resource]
