  ...
  static toDomain(doc: FirestoreDoc): Tenant {
    ...
    return {
      ...
      loyaltyConfig: {
        ...
        cardColor: data['loyaltyConfig']?.cardColor ?? DEFAULT_LOYALTY_CONFIG.cardColor,
        cardTextColor: data['loyaltyConfig']?.cardTextColor ?? DEFAULT_LOYALTY_CONFIG.cardTextColor,
        cardStyle: data['loyaltyConfig']?.cardStyle ?? DEFAULT_LOYALTY_CONFIG.cardStyle,
      },
